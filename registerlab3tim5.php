...
if(isset($_POST["submit"]))
{
    ...
    $ative = mysqli_query($connect,"SELECT active6 FROM computer_lab_3 WHERE `Day`='".$id."'");
     ...
     $query="UPDATE `computer_lab_3` SET `active6`=1, `country`=$lab,`4:30-6:30`='".$subject."' WHERE `Day`='".$id."'and `active6`=0";
...
<form  name="myForm"  method="POST">
        ...
        <option value="registerlab3tim4.php">4:30-6:30</option>
