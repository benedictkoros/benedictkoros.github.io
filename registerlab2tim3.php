...
if(isset($_POST["submit"]))
{
    ...
    $ative = mysqli_query($connect,"SELECT active3 FROM computer_lab_2 WHERE `Day`='".$id."'");
     ...
     $query="UPDATE `computer_lab_2` SET `active3`=1, `country`=$lab,`3rd`='".$subject."' WHERE `Day`='".$id."'and `active3`=0";
