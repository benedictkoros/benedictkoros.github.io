...
if(isset($_POST["submit"]))
{
    ...
    $ative = mysqli_query($connect,"SELECT active6 FROM computer_lab_4 WHERE `Day`='".$id."'");
     ...
     $query="UPDATE `computer_lab_4` SET `active6`=1, `country`=$lab,`6:30-8:30`='".$subject."' WHERE `Day`='".$id."'and `active6`=0";
...
<form  name="myForm"  method="POST">
        ...
        <option value="registerlab4tim1.php">8:30-10:30</option>
        <option value="registerlab4tim2.php">11:00-1:00</option>
        <option value="registerlab4tim3.php">2:00-4:00</option>
        <option value="registerlab4tim4.php">4:30-6:30</option>
