...
if(isset($_POST["submit"]))
{
    ...
    $ative = mysqli_query($connect,"SELECT active5 FROM computer_lab_4 WHERE `Day`='".$id."'");
     ...
     $query="UPDATE `computer_lab_4` SET `active5`=1, `country`=$lab,`4:30-6:30`='".$subject."' WHERE `Day`='".$id."'and `active5`=0";
...
<form  name="myForm"  method="POST">
        ...
        <option value="registerlab4tim5.php">6:30-8:30</option>
      </select>
      <br>
