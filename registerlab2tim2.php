...
if(isset($_POST["submit"]))
{
    ...
    $ative = mysqli_query($connect,"SELECT active2 FROM computer_lab_2 WHERE `Day`='".$id."'");
     ...
     $query="UPDATE `computer_lab_2` SET `active2`=1, `country`=$lab,`state2`='".$subject."' WHERE `Day`='".$id."'and `active2`=0";
...
<form  name="myForm"  method="POST">
        ...
        <option value="registerlab2tim4.php">4:30-6:30</option>
