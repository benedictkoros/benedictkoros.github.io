...
if(isset($_POST["submit"]))
{
    ...
    $ative = mysqli_query($connect,"SELECT active FROM computer_lab_2 WHERE `Day`='".$id."'");
     ...
     $query="UPDATE `computer_lab_2` SET `active`=1, `country`=$lab,`state`='".$subject."' WHERE `Day`='".$id."'and `active`=0";
