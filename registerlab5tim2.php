...
if(isset($_POST["submit"]))
{
    ...
    $ative = mysqli_query($connect,"SELECT active2 FROM computer_lab_5 WHERE `Day`='".$id."'");
     ...
     $query="UPDATE `computer_lab_5` SET `active2`=1, `country`=$lab,`state2`='".$subject."' WHERE `Day`='".$id."'and `active2`=0";
...
<form  name="myForm"  method="POST">
        ...
        <option value="registerlab5tim1.php">8:30-10:30</option>
