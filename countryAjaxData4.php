...
include('include/db_connect.php');
    ...
    $query = $mysqli->query("SELECT * FROM datalap3 WHERE status = 1 ORDER BY country_name ASC");// select all country from database 
    ...
    if($rowCount > 0)
		...
		{
	echo '<option value="">Select Computer Lab</option>';// initial message display{  
