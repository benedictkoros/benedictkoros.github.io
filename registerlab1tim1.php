...
if(isset($_POST["submit"]))
{
    ...
    $connect=mysqli_connect($hostname,$username,$password,$databaseName);
     ...
     $ative = mysqli_query($connect,"SELECT active FROM country_state_city_save WHERE `Day`='".$id."'");
     ...
     $query="UPDATE `country_state_city_save` SET `active`=1, `country`=$lab,`state`='".$subject."' WHERE `Day`='".$id."'and `active`=0";
