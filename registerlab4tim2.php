...
if(isset($_POST["submit"]))
{
    ...
    $ative = mysqli_query($connect,"SELECT active2 FROM computer_lab_4 WHERE `Day`='".$id."'");
     ...
     $query="UPDATE `computer_lab_4` SET `active2`=1, `country`=$lab,`state2`='".$subject."' WHERE `Day`='".$id."'and `active2`=0";
