...
<form  method="POST">
    ...
    <div class="form-group">
    	...
    	<select name="lab"onchange="location = this.value;" class="form-control" id="sel1">
    		    <option  ></option>
                <option value="register.php">1</option>
		        <option value="editlap2.php">2</option>
		        <option value="editlap3.php">3</option>
		        <option value="editlap4.php">4</option>
		        <option value="editlap5.php">5</option>
       ...
       <label for="sel1">Select time:</label>
        ...
        <option value="register3.php">11:00-1:00</option>
        <option value="register4.php">2:00-4:00</option>
        <option value="register5.php">4:30-6:30</option>
        <option value="register6.php">6:30-8:30</option>
      </select>
