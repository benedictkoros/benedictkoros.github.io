...
if(isset($_POST["submit"]))
{
    ...
    $ative = mysqli_query($connect,"SELECT active3 FROM computer_lab_3 WHERE `Day`='".$id."'");
     ...
     $query="UPDATE `computer_lab_3` SET `active3`=1, `country`=$lab,`3rd`='".$subject."' WHERE `Day`='".$id."'and `active3`=0";
