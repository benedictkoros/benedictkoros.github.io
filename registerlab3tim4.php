...
if(isset($_POST["submit"]))
{
    ...
    $ative = mysqli_query($connect,"SELECT active5 FROM computer_lab_3 WHERE `Day`='".$id."'");
     ...
     $query="UPDATE `computer_lab_3` SET `active5`=1, `country`=$lab,`4:30-6:30`='".$subject."' WHERE `Day`='".$id."'and `active5`=0";
...
<form  name="myForm"  method="POST">
        ...
        <option value="registerlab3tim1.php">8:30-10:30</option>
        <option value="registerlab3tim2.php">11:00-1:00</option>
        <option value="registerlab3tim3.php">2:00-4:00</option>
        <option selected="selected" >4:30-6:30</option>
        <option value="registerlab3tim5.php">6:30-8:30</option>
      </select>
      <br>
