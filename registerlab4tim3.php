...
if(isset($_POST["submit"]))
{
    ...
    $ative = mysqli_query($connect,"SELECT active4 FROM computer_lab_4 WHERE `Day`='".$id."'");
     $result2 = mysqli_fetch_array($ative);
       
         if($result2['active4']==0){
           //echo("You have successfuly ");
         //$id=$_POST['id'];
         //$lab=$_POST['country'];
         //$subject=$_POST['state'];

     $query="UPDATE `computer_lab_4` SET `active4`=1, `country`=$lab,`2:00:4:00`='".$subject."' WHERE `Day`='".$id."'and `active4`=0";
